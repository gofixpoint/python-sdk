...
class V1Evaluation(BaseModel):
    ...
    eval_type: Optional[EvaluationEvaluationType] = Field(default=None, alias="evalType")
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "evalType", "displayName", "description"]
