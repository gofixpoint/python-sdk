...
class V1ListExperimentsResponse(BaseModel):
    """
    V1ListExperimentsResponse
    """ # noqa: E501
    experiments: Optional[List[V1Experiment]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "experiments": [V1Experiment.from_dict(_item) for _item in obj["experiments"]] if obj.get("experiments") is not None else None,
