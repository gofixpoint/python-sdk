...
class V1ListExperimentRunsResponse(BaseModel):
    """
    V1ListExperimentRunsResponse
    """ # noqa: E501
    experiment_runs: Optional[List[V1ExperimentRun]] = Field(default=None, alias="experimentRuns")
    next_page_token: Optional[StrictStr] = Field(default=None, alias="nextPageToken")
    __properties: ClassVar[List[str]] = ["experimentRuns", "nextPageToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.experiment_runs:
            for _item in self.experiment_runs:
                if _item:
                    _items.append(_item.to_dict())
            _dict['experimentRuns'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "experimentRuns": [V1ExperimentRun.from_dict(_item) for _item in obj["experimentRuns"]] if obj.get("experimentRuns") is not None else None,
