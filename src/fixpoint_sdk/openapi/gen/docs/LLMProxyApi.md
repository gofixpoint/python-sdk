...
[**l_lm_proxy_get_evaluation**](LLMProxyApi.md#l_lm_proxy_get_evaluation) | **GET** /v1/{name_2} | 
[**l_lm_proxy_get_evaluation_run**](LLMProxyApi.md#l_lm_proxy_get_evaluation_run) | **GET** /v1/{name_3} | 
[**l_lm_proxy_get_experiment**](LLMProxyApi.md#l_lm_proxy_get_experiment) | **GET** /v1/{name} | 
[**l_lm_proxy_get_experiment_run**](LLMProxyApi.md#l_lm_proxy_get_experiment_run) | **GET** /v1/{name_1} | 
...
[**l_lm_proxy_list_evaluation_runs**](LLMProxyApi.md#l_lm_proxy_list_evaluation_runs) | **GET** /v1/{evaluationName} | 
[**l_lm_proxy_list_evaluations**](LLMProxyApi.md#l_lm_proxy_list_evaluations) | **GET** /v1/evaluations | 
[**l_lm_proxy_list_experiment_runs**](LLMProxyApi.md#l_lm_proxy_list_experiment_runs) | **GET** /v1/{experimentName}/runs | 
[**l_lm_proxy_list_experiments**](LLMProxyApi.md#l_lm_proxy_list_experiments) | **GET** /v1/experiments | 
...
[**l_lm_proxy_ping**](LLMProxyApi.md#l_lm_proxy_ping) | **POST** /v1/ping | 
...
# **l_lm_proxy_get_evaluation**
> V1Evaluation l_lm_proxy_get_evaluation(name_2)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LLMProxyApi(api_client)
    name_2 = 'name_2_example' # str | 

    try:
        api_response = api_instance.l_lm_proxy_get_evaluation(name_2)
        print("The response of LLMProxyApi->l_lm_proxy_get_evaluation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_get_evaluation: %s\n" % e)
```
...
# **l_lm_proxy_get_evaluation_run**
> V1EvaluationRun l_lm_proxy_get_evaluation_run(name_3)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LLMProxyApi(api_client)
    name_3 = 'name_3_example' # str | 

    try:
        api_response = api_instance.l_lm_proxy_get_evaluation_run(name_3)
        print("The response of LLMProxyApi->l_lm_proxy_get_evaluation_run:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_get_evaluation_run: %s\n" % e)
```
...
[**V1EvaluationRun**](V1EvaluationRun.md)
...
# **l_lm_proxy_get_experiment**
> V1Experiment l_lm_proxy_get_experiment(name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.l_lm_proxy_get_experiment(name)
        print("The response of LLMProxyApi->l_lm_proxy_get_experiment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_get_experiment: %s\n" % e)
```
...
# **l_lm_proxy_get_experiment_run**
> V1ExperimentRun l_lm_proxy_get_experiment_run(name_1)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LLMProxyApi(api_client)
    name_1 = 'name_1_example' # str | 

    try:
        api_response = api_instance.l_lm_proxy_get_experiment_run(name_1)
        print("The response of LLMProxyApi->l_lm_proxy_get_experiment_run:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_get_experiment_run: %s\n" % e)
```
...
[**V1ExperimentRun**](V1ExperimentRun.md)
...
# **l_lm_proxy_list_evaluation_runs**
> V1ListEvaluationRunsResponse l_lm_proxy_list_evaluation_runs(evaluation_name, page_size=page_size, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LLMProxyApi(api_client)
    evaluation_name = 'evaluation_name_example' # str | 
    page_size = 56 # int |  (optional)
    page_token = 'page_token_example' # str |  (optional)

    try:
        api_response = api_instance.l_lm_proxy_list_evaluation_runs(evaluation_name, page_size=page_size, page_token=page_token)
        print("The response of LLMProxyApi->l_lm_proxy_list_evaluation_runs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_list_evaluation_runs: %s\n" % e)
```
...
[**V1ListEvaluationRunsResponse**](V1ListEvaluationRunsResponse.md)
...
# **l_lm_proxy_list_evaluations**
> V1ListEvaluationsResponse l_lm_proxy_list_evaluations(page_size=page_size, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.l_lm_proxy_list_evaluations(page_size=page_size, page_token=page_token)
        print("The response of LLMProxyApi->l_lm_proxy_list_evaluations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_list_evaluations: %s\n" % e)
```
...
[**V1ListEvaluationsResponse**](V1ListEvaluationsResponse.md)
...
# **l_lm_proxy_list_experiment_runs**
> V1ListExperimentRunsResponse l_lm_proxy_list_experiment_runs(experiment_name, page_size=page_size, page_token=page_token)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.l_lm_proxy_list_experiment_runs(experiment_name, page_size=page_size, page_token=page_token)
        print("The response of LLMProxyApi->l_lm_proxy_list_experiment_runs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_list_experiment_runs: %s\n" % e)
```
...
[**V1ListExperimentRunsResponse**](V1ListExperimentRunsResponse.md)
...
# **l_lm_proxy_list_experiments**
> V1ListExperimentsResponse l_lm_proxy_list_experiments(page_size=page_size, page_token=page_token, mode=mode)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.l_lm_proxy_list_experiments(page_size=page_size, page_token=page_token, mode=mode)
        print("The response of LLMProxyApi->l_lm_proxy_list_experiments:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_list_experiments: %s\n" % e)
```
...
# **l_lm_proxy_ping**
> V1PongResponse l_lm_proxy_ping(body)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LLMProxyApi(api_client)
    body = openapi_client.V1PingRequest() # V1PingRequest | 

    try:
        api_response = api_instance.l_lm_proxy_ping(body)
        print("The response of LLMProxyApi->l_lm_proxy_ping:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LLMProxyApi->l_lm_proxy_ping: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**V1PingRequest**](V1PingRequest.md)|  | 

### Return type

[**V1PongResponse**](V1PongResponse.md)
