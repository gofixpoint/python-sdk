...
class FixpointClient:
  ...
  class _Fixpoint:
    ...
    class _UserFeedback:
      ...
      def create(self, request: types.CreateUserFeedbackRequest) -> types.CreateUserFeedbackResponse:
    ...
    class _Attributes:
      ...
      def create(self, request: types.CreateLogAttributeRequest) -> requests.Response:
